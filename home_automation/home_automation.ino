...
const char DEVICE_LOGIN_NAME[]  = "2431b93e-c0eb-4f74-bb55-41b58e627f37"; //Enter DEVICE ID

const char SSID[]               = "name";    //Enter WiFi SSID (name)
const char PASS[]               = "pass";    //Enter WiFi password
const char DEVICE_KEY[]         = "key";    //Enter Secret device password (Secret Key)
